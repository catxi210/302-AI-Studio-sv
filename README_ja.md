...
### エージェントサンドボックス管理
- 🌐 リモートおよびローカルの2種類のエージェント実行プラットフォームをサポート
- 📦 エージェントサンドボックス一覧の管理、すべての利用可能なサンドボックスを素早く確認
- 🔍 サンドボックス検索機能、目的のサンドボックスを迅速に特定
- 📈 サンドボックスセッション統計、セッション数や時間情報を表示
- 🔄 ワンクリックでサンドボックス一覧を最新状態にリフレッシュ
