...
export interface AutoGeneratedIpcServices {
	...
	providerService: {
		handle302AIProviderChange(apiKey: string): Promise<void>;
	};
	ssoService: {
		openSsoLogin(
			serverPort: number,
	...
	threadService: {
		...
		clearDeletedModelReferences(deletedModelIds: string[]): Promise<number>;
	};
	updaterService: {
...
export const autoGeneratedServices: AutoGeneratedIpcServices = {
	...
	providerService: {
		handle302AIProviderChange: (apiKey: string) =>
			ipcRenderer.invoke("providerService:handle302AIProviderChange", apiKey),
	},
	ssoService: {
	...
	threadService: {
		...
		clearDeletedModelReferences: (deletedModelIds: string[]) =>
			ipcRenderer.invoke("threadService:clearDeletedModelReferences", deletedModelIds),
	},
	updaterService: {
...
export interface ElectronAPIExtension {
	...
	providerService: AutoGeneratedIpcServices["providerService"];
