/* eslint-disable @typescript-eslint/no-explicit-any */
		...
		import type { PluginMarketEntry, BroadcastEvent, StorageValue, StorageOptions, StorageMetadata, StorageMeta, StorageItem, InstalledPlugin, ProviderDefinition, PluginSource, ModelProvider, Model, LanguageCode, InsertTarget, ShortcutBinding, ShortcutConflict, ShortcutSyncEvent, TabType, Tab, Theme, ImportResult, BackupInfo, McpServer, ThreadData, UpdateChannel } from '@shared/types';
...
getCacheInfo(): Promise<{ valid: boolean; age: number; pluginCount: number; lastUpdated?: string }>;
};
broadcastService: {
...
executeAfterSendMessageHook(context: {
		messages: unknown[];
		userMessage: unknown;
		model: Model;
		provider: ModelProvider;
...
executeErrorHook(errorData: { message: string; stack?: string; name?: string }, context: {
		source: string;
		provider?: ModelProvider;
		model?: Model;
		metadata?: Record<string, unknown>;
...
codeAgentService: {
updateClaudeCodeSandboxModel(threadId: string, sandbox_id: string, llm_model: string): Promise<{ isOK: boolean; llm_model: string }>;
...
updateClaudeCodeCurrentSessionIdByThreadId(threadId: string, sessionId: string): Promise<{ isOK: boolean }>;
updateClaudeCodeSandboxRemark(sandbox_id: string, remark: string): Promise<{ isOK: boolean; remark: string }>;
createClaudeCodeSandboxByIpc(threadId: string, sandboxName: string): Promise<{ isOK: boolean; sandboxId: string }>;
deleteClaudeCodeSandboxByIpc(sandbox_id: string): Promise<{ isOK: boolean; error?: string }>;
updateClaudeCodeSessionRemark(sandbox_id: string, session_id: string, remark: string): Promise<{ isOK: boolean }>;
deleteClaudeCodeSession(sandbox_id: string, session_id: string): Promise<{ isOK: boolean }>;
checkClaudeCodeSandboxDisk(): Promise<void>;
...
handleDropAtPointer(tabId: string, pointer: { screenX: number; screenY: number }): Promise<
...
handleMoveTabIntoExistingWindow(triggerTabId: string, windowId: string, insertIndex?: number): Promise<void>;
};
shortcutService: {
...
tabService: {
handleNewTabWithThread(threadId: string, title: string, type: TabType, active: boolean): Promise<string | null>;
handleNewTab(title: string, type: TabType, active: boolean, href?: string, content?: string, previewId?: string): Promise<string | null>;
...
handleTabCloseOffside(tabId: string, tabIdsToClose: string[], _remainingTabIds: string[], shouldSwitchActive: boolean): Promise<void>;
...
ssoService: {
openSsoLogin(serverPort: number, language: string): Promise<{ success: boolean; error?: string }>;
waitForSsoCallback(timeoutMs: number): Promise<{ success: boolean; apiKey?: string; error?: string }>;
cancelSsoLogin(): void;
};
threadService: {
...
getMarketplacePlugin: (pluginId: string) => ipcRenderer.invoke('registryService:getMarketplacePlugin', pluginId),
searchMarketplacePlugins: (query: string) => ipcRenderer.invoke('registryService:searchMarketplacePlugins', query),
...
broadcastService: {
broadcastExcludeSource: (broadcastEvent: BroadcastEvent, data: any) => ipcRenderer.invoke('broadcastService:broadcastExcludeSource', broadcastEvent, data),
broadcastToAll: (broadcastEvent: BroadcastEvent, data: any) => ipcRenderer.invoke('broadcastService:broadcastToAll', broadcastEvent, data),
},
storageService: {
setItem: (key: string, value: StorageValue) => ipcRenderer.invoke('storageService:setItem', key, value),
...
removeItem: (key: string, options: StorageOptions) => ipcRenderer.invoke('storageService:removeItem', key, options),
...
setMeta: (key: string, metadata: StorageMeta) => ipcRenderer.invoke('storageService:setMeta', key, metadata),
...
setItems: (items: StorageItem<StorageValue>[]) => ipcRenderer.invoke('storageService:setItems', items),
...
disablePlugin: (pluginId: string) => ipcRenderer.invoke('pluginService:disablePlugin', pluginId),
installPlugin: (source: PluginSource) => ipcRenderer.invoke('pluginService:installPlugin', source),
uninstallPlugin: (pluginId: string) => ipcRenderer.invoke('pluginService:uninstallPlugin', pluginId),
checkForUpdates: (pluginId: string) => ipcRenderer.invoke('pluginService:checkForUpdates', pluginId),
...
getPluginConfig: (pluginId: string) => ipcRenderer.invoke('pluginService:getPluginConfig', pluginId),
setPluginConfig: (pluginId: string, config: Record<string, unknown>) => ipcRenderer.invoke('pluginService:setPluginConfig', pluginId, config),
getPluginConfigValue: (pluginId: string, key: string) => ipcRenderer.invoke('pluginService:getPluginConfigValue', pluginId, key),
setPluginConfigValue: (pluginId: string, key: string, value: unknown) => ipcRenderer.invoke('pluginService:setPluginConfigValue', pluginId, key, value),
fetchModelsFromProvider: (provider: ModelProvider) => ipcRenderer.invoke('pluginService:fetchModelsFromProvider', provider),
executeBeforeSendMessageHook: (context: {
		messages: unknown[];
		userMessage: unknown;
		model: Model;
...
generalSettingsService: {
handleLanguageChanged: (language: LanguageCode) => ipcRenderer.invoke('generalSettingsService:handleLanguageChanged', language),
},
codeAgentService: {
updateClaudeCodeSandboxModel: (threadId: string, sandbox_id: string, llm_model: string) => ipcRenderer.invoke('codeAgentService:updateClaudeCodeSandboxModel', threadId, sandbox_id, llm_model),
checkClaudeCodeSandbox: (sandboxId: string) => ipcRenderer.invoke('codeAgentService:checkClaudeCodeSandbox', sandboxId),
updateClaudeCodeSandboxesByIpc: () => ipcRenderer.invoke('codeAgentService:updateClaudeCodeSandboxesByIpc'),
updateClaudeCodeSessions: (sandboxId: string) => ipcRenderer.invoke('codeAgentService:updateClaudeCodeSessions', sandboxId),
updateClaudeCodeCurrentSessionIdByThreadId: (threadId: string, sessionId: string) => ipcRenderer.invoke('codeAgentService:updateClaudeCodeCurrentSessionIdByThreadId', threadId, sessionId),
updateClaudeCodeSandboxRemark: (sandbox_id: string, remark: string) => ipcRenderer.invoke('codeAgentService:updateClaudeCodeSandboxRemark', sandbox_id, remark),
createClaudeCodeSandboxByIpc: (threadId: string, sandboxName: string) => ipcRenderer.invoke('codeAgentService:createClaudeCodeSandboxByIpc', threadId, sandboxName),
deleteClaudeCodeSandboxByIpc: (sandbox_id: string) => ipcRenderer.invoke('codeAgentService:deleteClaudeCodeSandboxByIpc', sandbox_id),
updateClaudeCodeSessionRemark: (sandbox_id: string, session_id: string, remark: string) => ipcRenderer.invoke('codeAgentService:updateClaudeCodeSessionRemark', sandbox_id, session_id, remark),
deleteClaudeCodeSession: (sandbox_id: string, session_id: string) => ipcRenderer.invoke('codeAgentService:deleteClaudeCodeSession', sandbox_id, session_id),
checkClaudeCodeSandboxDisk: () => ipcRenderer.invoke('codeAgentService:checkClaudeCodeSandboxDisk'),
findClaudeCodeSandboxWithValidDisk: (threadId: string) => ipcRenderer.invoke('codeAgentService:findClaudeCodeSandboxWithValidDisk', threadId),
},
ghostWindowService: {
...
updateInsertIndex: (target: InsertTarget) => ipcRenderer.invoke('ghostWindowService:updateInsertIndex', target),
},
windowService: {
handleOpenSettingsWindow: (route?: string) => ipcRenderer.invoke('windowService:handleOpenSettingsWindow', route),
focusWindow: (windowId: string, tabId?: string) => ipcRenderer.invoke('windowService:focusWindow', windowId, tabId),
handleDropAtPointer: (tabId: string, pointer: { screenX: number; screenY: number }) => ipcRenderer.invoke('windowService:handleDropAtPointer', tabId, pointer),
handleSplitShellWindow: (triggerTabId: string) => ipcRenderer.invoke('windowService:handleSplitShellWindow', triggerTabId),
handleMoveTabIntoExistingWindow: (triggerTabId: string, windowId: string, insertIndex?: number) => ipcRenderer.invoke('windowService:handleMoveTabIntoExistingWindow', triggerTabId, windowId, insertIndex),
},
shortcutService: {
init: (shortcuts: ShortcutBinding[]) => ipcRenderer.invoke('shortcutService:init', shortcuts),
updateShortcuts: (shortcuts: ShortcutBinding[]) => ipcRenderer.invoke('shortcutService:updateShortcuts', shortcuts),
getConflicts: () => ipcRenderer.invoke('shortcutService:getConflicts'),
getSyncInfo: () => ipcRenderer.invoke('shortcutService:getSyncInfo'),
},
tabService: {
handleNewTabWithThread: (threadId: string, title: string, type: TabType, active: boolean) => ipcRenderer.invoke('tabService:handleNewTabWithThread', threadId, title, type, active),
handleNewTab: (title: string, type: TabType, active: boolean, href?: string, content?: string, previewId?: string) => ipcRenderer.invoke('tabService:handleNewTab', title, type, active, href, content, previewId),
...
handleTabClose: (tabId: string, newActiveTabId: string | null) => ipcRenderer.invoke('tabService:handleTabClose', tabId, newActiveTabId),
handleTabCloseOthers: (tabId: string, tabIdsToClose: string[]) => ipcRenderer.invoke('tabService:handleTabCloseOthers', tabId, tabIdsToClose),
handleTabCloseOffside: (tabId: string, tabIdsToClose: string[], _remainingTabIds: string[], shouldSwitchActive: boolean) => ipcRenderer.invoke('tabService:handleTabCloseOffside', tabId, tabIdsToClose, _remainingTabIds, shouldSwitchActive),
handleShellViewLevel: (up: boolean) => ipcRenderer.invoke('tabService:handleShellViewLevel', up),
replaceTabContent: (tabId: string, newThreadId: string) => ipcRenderer.invoke('tabService:replaceTabContent', tabId, newThreadId),
handleClearTabMessages: (tabId: string, threadId: string) => ipcRenderer.invoke('tabService:handleClearTabMessages', tabId, threadId),
handleGenerateTabTitle: (tabId: string, threadId: string) => ipcRenderer.invoke('tabService:handleGenerateTabTitle', tabId, threadId),
},
aiApplicationService: {
getAiApplicationUrl: (applicationId: number) => ipcRenderer.invoke('aiApplicationService:getAiApplicationUrl', applicationId),
handle302AIProviderChange: (updatedApiKey: string) => ipcRenderer.invoke('aiApplicationService:handle302AIProviderChange', updatedApiKey),
handleAiApplicationReload: (tabId: string) => ipcRenderer.invoke('aiApplicationService:handleAiApplicationReload', tabId),
},
appService: {
...
restoreFromBackup: (backupPath: string) => ipcRenderer.invoke('dataService:restoreFromBackup', backupPath),
deleteBackup: (backupPath: string) => ipcRenderer.invoke('dataService:deleteBackup', backupPath),
...
externalLinkService: {
openExternalLink: (url: string) => ipcRenderer.invoke('externalLinkService:openExternalLink', url),
},
mcpService: {
getToolsFromServer: (server: McpServer) => ipcRenderer.invoke('mcpService:getToolsFromServer', server),
closeServer: (serverId: string) => ipcRenderer.invoke('mcpService:closeServer', serverId),
},
ssoService: {
openSsoLogin: (serverPort: number, language: string) => ipcRenderer.invoke('ssoService:openSsoLogin', serverPort, language),
waitForSsoCallback: (timeoutMs: number) => ipcRenderer.invoke('ssoService:waitForSsoCallback', timeoutMs),
...
renameThread: (threadId: string, newName: string) => ipcRenderer.invoke('threadService:renameThread', threadId, newName),
addFavorite: (threadId: string) => ipcRenderer.invoke('threadService:addFavorite', threadId),
removeFavorite: (threadId: string) => ipcRenderer.invoke('threadService:removeFavorite', threadId),
},
updaterService: {
...
setAutoUpdate: (enabled: boolean) => ipcRenderer.invoke('updaterService:setAutoUpdate', enabled),
setUpdateChannel: (channel: UpdateChannel) => ipcRenderer.invoke('updaterService:setUpdateChannel', channel),
