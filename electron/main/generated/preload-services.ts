...
export const autoGeneratedServices: AutoGeneratedIpcServices = {
	...
	codeAgentService: {
		...
		updateClaudeCodeSessionRemark: (sandbox_id: string, session_id: string, remark: string) =>
			ipcRenderer.invoke(
		...
		checkClaudeCodeSandboxDisk: () =>
			ipcRenderer.invoke("codeAgentService:checkClaudeCodeSandboxDisk"),
